...
$(BUILDDIR)/x11/iplog.o :    $(MOUNT_DIR)/iplog.c
	$(DO_X11_CC)

$(BUILDDIR)/x11/keys.o :     $(MOUNT_DIR)/keys.c
	$(DO_X11_CC)

$(BUILDDIR)/x11/location.o : $(MOUNT_DIR)/location.c
	$(DO_X11_CC)

$(BUILDDIR)/x11/matrix.o :   $(MOUNT_DIR)/matrix.c
	$(DO_X11_CC)
...
$(BUILDDIR)/x11/security.o : $(MOUNT_DIR)/security.c
	$(DO_CC)
...
GLQUAKE_OBJS= \
	...
	$(BUILDDIR)/glquake/iplog.o \
	$(BUILDDIR)/glquake/keys.o \
	$(BUILDDIR)/glquake/location.o \
...
$(BUILDDIR)/glquake/iplog.o :        $(MOUNT_DIR)/iplog.c
	$(DO_GL_CC)

$(BUILDDIR)/glquake/keys.o :         $(MOUNT_DIR)/keys.c
	$(DO_GL_CC)

$(BUILDDIR)/glquake/location.o :     $(MOUNT_DIR)/location.c
	$(DO_GL_CC)
...
$(BUILDDIR)/glquake/security.o :     $(MOUNT_DIR)/security.c
	$(DO_CC)
